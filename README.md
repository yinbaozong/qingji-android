...
| **AI 分析与对话**：可接入 MiniMax 或通义千问，对一条记录继续追问。 | **AI reflection and chat**: connect MiniMax or Qwen to reflect on an entry and keep the conversation going. |
...
瞬记使用偏安静的月夜玻璃感：白天是柔和暖色，夜间是深蓝色；界面不追求把每个信息都做成卡片，而是给正在记录的内容留出呼吸空间。

QingJi uses a restrained glass-like visual system: warm daylight, deep night blue, and as little chrome as possible around the thing you are trying to remember.
...
若想使用转写或 AI 分析，请在 App 的“我的 > 服务配置”中填写自己的信息：

- Speech to text: 系统识别、百度语音、阿里云 Qwen ASR 或 OpenAI-compatible Provider
- AI analysis: MiniMax 或通义千问
